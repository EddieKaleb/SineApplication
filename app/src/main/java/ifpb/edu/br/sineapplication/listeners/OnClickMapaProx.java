...
/**
 * Created by eddie on 19/02/2017.
 */

public class OnClickMapaProx implements View.OnClickListener,LocationListener{
    MainActivity main;
    ...
    public OnClickMapaProx(MainActivity mainActivity) {
    ...
    private void startMapsActivity(){
        ...
        intent = new Intent(main, MapsActivity.class);
        bundle = new Bundle();
